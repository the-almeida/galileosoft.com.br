    ...
    <main className="flex min-h-screen flex-col items-center justify-between pt-16 bg-purple-950">
      <section className="relative w-full">
        ...
        <ContentContainer className="w-full grid grid-cols-2 gap-x-20 gap-y-2 justify-between items-start relative z-10 my-10">
          <div>
            <span className="text-xl md:text-2xl font-semibold text-green-500">ENTRE EM CONTATO</span>
            <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl mb-4 font-semibold pt-3 pb-8">Pronto para modernizar sua empresa?</h1>
